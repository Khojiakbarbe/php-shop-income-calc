                ...
                <div class="col-9">
                    <table class="table table-bordered text-center mytable">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <?= $pdoQarzdorData['olingan_qarz'] ?>
                                </td>
                                <td>
                                    <?= $pdoQarzdorData['berilgan_qarz'] ?>
                                </td>
                                <td class="get">
                                    <?= $pdoQarzdorData['olingan_qarz'] - $pdoQarzdorData['berilgan_qarz'] ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <?php while ($dataMap = $pdoForMap->fetch()) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= $dataMap['olingan_qarz'] ?>
                                    </td>
                                    <td>
                                        <?= $dataMap['berilgan_qarz'] ?>
                                    </td>
                                    <td>
                                        <?= $dataMap['olingan_qarz'] - $dataMap['berilgan_qarz'] ?>
                                    </td>
                                    <td>
                                        <?= $dataMap['comment'] ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" data-popper-placement="top-end">
                                                <li><a href="xodimShow.php?id=<?= $dataMap['user_id'] ?>">
                                                        <button class="dropdown-item" type="button"><i
                                                                class="bi col-12 btn btn-success bi-eye-fill">show</i>
                                                        </button></a></li>
                                                <li><a href="xodimEdit.php?id=<?= $dataMap['user_id'] ?>"><button
                                                            class="dropdown-item" type="button"><i
                                                                class="bi col-12 btn btn-warning bi-pencil-square"> edit
                                                            </i></button></a>
                                                </li>
                                                <li>
                                                    <form action="xodimlarDelete.php?id=<?= $dataMap['id'] ?>" method="Post">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-9 " id="staticBackdropLabel">Ish xaqqi qo'shish</h1>
